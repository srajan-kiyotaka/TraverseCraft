...
class CreateGridWorld:
    """
    """
    def __init__(self, worldName:str, rows:int, cols:int, cellSize:int=10, pathColor:str="green", blockCode:int=36, cellPadding:int=2, borderWidth:int=2):
        # ~~~~~ World Attributes ~~~~~ #
